...
.PHONY: dev
dev: 
	flutterfire configure --project=wordwolf-1f53d --out=lib/util/environment/src/firebase_options_dev.dart --platforms=android,ios,web --ios-bundle-id=com.left.device.dev --android-package-name=com.left.device.dev

.PHONY: prod
prod:
	flutterfire configure --project=left-device --out=lib/util/environment/src/firebase_options_prod.dart --platforms=android,ios,web --ios-bundle-id=com.left.device --android-package-name=com.left.device
