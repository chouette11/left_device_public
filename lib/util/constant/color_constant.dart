...
class ColorConstant {
  ...
  static const disableText = Color(0xFF787878);

  static const defaultButton = Color(0xFFFEF7FF);
  static const button1 = Color(0xFFE4FFCD);
  static const button2 = Color(0xFFFFCDCD);
  static const button3 = Color(0xFFCDCFFF);
  static const button4 = Color(0xFFFFFDCD);
